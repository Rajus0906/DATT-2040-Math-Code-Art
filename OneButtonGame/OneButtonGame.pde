//LOWER VOLUME SOUND EFFECTS ARE PRETTY LOUD SORRY.
...
void setup() {
  ...
  Win = new Gif(this, "YouWin.gif");//https://tenor.com/view/luigi-you-win-you-won-super-mario-clapping-gif-17521512
  Win.loop();
  ...
  PewSound = new SoundFile(this, "Pew.mp3");//https://happysoulmusic.com/audio/retro_game_weapons_sound_effects_-_pew__003-mp3/
  BoomSound = new SoundFile(this, "Boom.mp3");
  WinningSound = new SoundFile(this, "Won.mp3");//https://elements.envato.com/winning-TB7L64W?utm_source=mixkit&utm_medium=referral&utm_campaign=elements_mixkit_cs_sfx_tag&_ga=2.131106319.1847802724.1670779668-70395368.1670779668
}
